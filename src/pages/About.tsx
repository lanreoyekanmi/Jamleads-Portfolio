...
const AboutPage = () => {
  return (
    <>
      ...
      <section className="container mx-auto px-4 sm:px-6 py-10 sm:py-20 flex flex-col gap-10 sm:gap-16 lg:flex-row lg:items-start lg:gap-0 relative">
        {/* Left Side */}
        <div className="flex flex-col items-center sm:items-center lg:items-start w-full lg:w-1/2 mb-8 sm:mb-12 lg:mb-0 lg:sticky lg:top-12 lg:self-start z-20">
          ...
          <div className="flex items-center mb-4 sm:mb-6">
            ...
            <span className="text-base sm:text-lg font-medium">Available for work</span>
          </div>
          {/* About me heading below available for work */}
          <h1 className="text-3xl sm:text-5xl md:text-6xl lg:text-7xl font-bold mb-6 sm:mb-10 leading-tight mt-2 sm:mt-4 text-center sm:text-left">About me</h1>
          {/* Profile, Social, and Not to brag in a row on desktop, stacked on mobile */}
          <div className="flex flex-col sm:flex-row items-center sm:items-start w-full gap-6 sm:gap-8 mb-2 sm:mb-4">
            <img
              src="/profile.jpg"
              alt="Profile"
              className="w-24 h-24 sm:w-32 sm:h-32 rounded-full object-cover border-4 border-[#222] mb-3 sm:mb-0 shadow-lg"
            ...
            <div className="flex flex-col items-center sm:items-start gap-2 w-full">
              ...
              {/* Not to brag, but.. */}
              <div className="text-center sm:text-left w-full max-w-xs">
                <h3 className="text-xl sm:text-2xl font-semibold mb-1 sm:mb-2">Not to brag, but..</h3>
                <p className="text-base sm:text-lg font-light leading-snug">
        ...
        {/* Right Side */}
        <div className="flex-1 flex flex-col justify-center items-start w-full mt-10 sm:mt-24">
          <div className="text-base sm:text-lg md:text-2xl font-light leading-relaxed max-w-full sm:max-w-2xl space-y-3 sm:space-y-6 px-1 sm:px-0">
          ...
          <div className="w-full mt-6 sm:mt-12 flex flex-col gap-5 sm:gap-8">
            <ContactSection />
          </div>
        </div>
      </section>
